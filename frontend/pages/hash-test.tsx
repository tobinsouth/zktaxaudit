...
export default function RedactAndProve() {
    ...
    const generateJSON = async () => {
        ...
        console.log('extracted.formattedJSON', extracted.formattedJSON)
        setStringifiedJSON(extracted.formattedJSON);
    ...
    const generateProof = async () => {
        ...
        try{
            ...
            //for (var key of REQUIRED_FIELDS) { // TODO: change me back
            for (const [key, _value] of Object.entries(JsonDataStore)) { // TODO: change me back
                console.log('getting tick on key', key)
            ...
            // Tobin was using buffer2bits here
